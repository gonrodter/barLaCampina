...
<body style="background: #0f2027; background: linear-gradient(to right,#2c5364, #203a43, #0f2027">
    ...
    <form method="get" action="validacion_eliminacion_producto.php" <!-- onsubmit="return ValidarCuenta() -->">
              ...
              <div class="screen-body">
                ...
                <div class="screen-body-item">
                  <div class="app-form">
                   ...
                   <select name="OIDPROD" id="selectbox" data-selected="">
                        <option  selected="selected" disabled="disabled">Elige el Nº de Producto</option>
                        <?php foreach($filas as $fila) { ?>
                        <option value="<?php echo $fila["OIDPROD"]; ?>"><?php echo $fila["OIDPROD"]; ?></option>
                        <?php } ?>
                    </select>
