...
<head>
  ...
  <title>Eliminacion de Pedidos</title>
</head>
<body style="background: #0f2027; background: linear-gradient(to right,#2c5364, #203a43, #0f2027">
    ...
    ?>
    <form method="get" action="validacion_eliminacion_pedido.php" <!-- onsubmit="return ValidarCuenta() -->">
            ...
            <div class="screen">
              ...
              <div class="screen-body">
                ...
                <div class="screen-body-item">
                  <div class="app-form"> 
                   <select name="OIDLP" id="selectbox" data-selected="">
                        <option  selected="selected" disabled="disabled">Elige el LP</option>
                        <?php foreach($filas as $fila) { ?>
                        <option value="<?php echo $fila["OIDLP"]; ?>"><?php echo $fila["OIDLP"]; ?></option>
                        <?php } ?>
                    </select>
