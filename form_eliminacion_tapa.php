...
<head>
  ...
  <title>Eliminacion de Tapas</title>
</head>
...
<body style="background: #0f2027; background: linear-gradient(to right,#2c5364, #203a43, #0f2027">
    ...
    <form method="get" action="validacion_eliminacion_tapa.php" <!-- onsubmit="return ValidarCuenta() -->">
              ...
              <div class="screen-body">
                ...
                <div class="screen-body-item">
                  <div class="app-form">
                   ...
                   <select name="OIDTAP" id="selectbox" data-selected="">
                        <option  selected="selected" disabled="disabled">Elige el Nº de Tapa</option>
                        <?php foreach($filas as $fila) { ?>
                        <option value="<?php echo $fila["OIDTAP"]; ?>"><?php echo $fila["OIDTAP"]; ?></option>
                        <?php } ?>
                    </select>
