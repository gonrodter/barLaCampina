                ...
                <div class="screen-body-item">
                  <div class="app-form">
                    <div class="app-form-group">
                      <input id="OIDPROD" type="text" name="OIDPROD" class="app-form-control" placeholder="Nº PRODUCTO" value="<?php echo $pedido['OIDPROD'];?>" />
                    </div>
                    <div class="app-form-group">
                    ...
                    <div class="app-form-group message">
                      <input id="NPEDIDO" type="text" name="NPEDIDO" class="app-form-control" placeholder="Nº PEDIDO" value="<?php echo $pedido['NPEDIDO'];?>" />
                    </div>
