...
<head>
  ...
  <title>Tapa añadida con éxito</title>
</head>
...
<body style="background: #0f2027; background: linear-gradient(to right,#2c5364, #203a43, #0f2027">
    ...
    <main>
        ...
        <?php insertar_tapa($conexion, $nuevaTapa);?>
        

            <h1 style="text-align: center; color: #5F9EA0">Has añadido la nueva tapa con nombre <?php echo $nuevaTapa["NOMBRETAPAS"]; ?></h1>
            <div style="font-size: 18px; text-align: center; color: #5F9EA0">   
                Pulsa <a href="tapas.php">aquí</a> para acceder al listado de tapas.
            </div>
