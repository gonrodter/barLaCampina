...
<head>
  ...
  <title>Eliminacion de Bebidas</title>
</head>
...
<body style="background: #0f2027; background: linear-gradient(to right,#2c5364, #203a43, #0f2027">
    ...
    <form method="get" action="validacion_eliminacion_bebida.php" <!-- onsubmit="return ValidarCuenta() -->">
            ...
            <div class="screen">
              ...
              <div class="screen-body">
                <div class="screen-body-item left">
                  ...
                  <div style= "padding-top:25px" id = "barraTitle" class="app-contact">Bar La Campiña</div>
                </div>
                <div class="screen-body-item">
                  <div class="app-form">
                     
                   <select name="OIDBEB" id="selectbox" data-selected="">
                        <option  selected="selected" disabled="disabled">Elige el Nº de Bebida</option>
                        <?php foreach($filas as $fila) { ?>
                        <option value="<?php echo $fila["OIDBEB"]; ?>"><?php echo $fila["OIDBEB"]; ?></option>
                        <?php } ?>
                    </select>
